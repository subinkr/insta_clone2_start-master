...
class _FeedWidgetState extends State<FeedWidget> {
  ...
  Widget build(BuildContext context) {
    var comment = widget.document.data()['comment'] ?? 0;
    return Column(
      children: <Widget>[
        ListTile(
          leading: CircleAvatar(
            backgroundImage: NetworkImage(widget.document.data()['userPhotoUrl']),
          ),
          title: Text(
        ...
        ListTile(
          leading: Row(
            ...
            children: <Widget>[
              widget.document.data()['likedUsers']?.contains(widget.user.email) ??
                      false
                  ? GestureDetector(
                      onTap: _unlike,
                      child: Icon(
        ...
        Row(
          children: <Widget>[
            ...
            Text(widget.document.data()['contents']),
          ],
        ),
        SizedBox(
          height: 8.0,
